...
def sendSQLCommand(command, userID, table, authorised = True, fetch = 1): # NO USER INPUT SHOULD BE SENT DIRECTLY HERE
    ...
    if Enforcer.enforce(userID, table, "*", action, authorised):
